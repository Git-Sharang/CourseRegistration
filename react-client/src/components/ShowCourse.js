  ...
  return (
    <div>
      ...
      <Jumbotron>
        ...
        <p>
          <Button type="button" variant="primary" onClick={() => { editCourse(data._id) }}>Change the Section</Button>&nbsp;
          <Button type="button" variant="danger" onClick={() => { deleteCourse(data._id) }}>Drop the course</Button>
        </p>
      </Jumbotron>
      <Footer/>
    </div>
